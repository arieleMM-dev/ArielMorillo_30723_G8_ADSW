...
function PerfilContent() {
  ...
  async function saveDatos(e: React.FormEvent) {
    ...
    if (telefono && !/^\d{7,15}$/.test(telefono)) {
      setToastDatos('error:Formato de teléfono inválido (solo dígitos, 7-15 caracteres)');
      return;
    }
    setSavingDatos(true);
  ...
  return (
    <div style={{ maxWidth: 680, margin: '0 auto' }}>
      ...
      <div className="card" style={{ marginBottom: '1.25rem', display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
        <div className="profile-avatar-large" style={{ fontSize: '2.25rem', fontWeight: 700 }}>
          {initials}
        </div>
        <div>
        ...
        <div className="card">
          ...
          <form onSubmit={saveDatos} id="form-perfil-datos">
            ...
            <div style={{ marginBottom: '1rem' }}>
              ...
              <div style={{ border: '2px dashed var(--border-color)', borderRadius: 'var(--radius-md)', padding: '1.5rem', textAlign: 'center', color: 'var(--text-muted)', cursor: 'pointer', transition: 'border-color var(--transition)' }}
                ...
                <p style={{ fontSize: '0.85rem' }}>Arrastra tu foto aquí o haz clic</p>
