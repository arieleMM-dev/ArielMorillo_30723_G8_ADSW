...
export default function NuevoAgricultorPage() {
  ...
  const [form, setForm] = useState({ nombres: '', apellidos: '', cedula: '', email: '', rol: 'AGRICULTOR' });
  ...
  function validate(): boolean {
    ...
    if (!validarCedulaFrontend(form.cedula))
      e.cedula = 'Cédula ecuatoriana inválida (10 dígitos)';
    setErrors(e);
    ...
    return (
      <div style={{ maxWidth: 520, margin: '0 auto', textAlign: 'center', padding: '2rem 0' }}>
        ...
        <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'center' }}>
          <button className="btn btn-secondary" onClick={() => { setSuccessInfo(null); setForm({ nombres: '', apellidos: '', cedula: '', email: '', rol: 'AGRICULTOR' }); }}>
            Crear otro
          </button>
